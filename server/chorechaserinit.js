...
//         const groupCounter = db.collection("counter"); //for auto-incrementing ids
//
//         // add group record
//         const familyGroup = {
//             // id: 1,
...
//                     //------
//                     groupCounter.drop();
//                     groupCounter.insertOne({
//                                                "_id":"groupId",
//                                                "sequence_value": 0
//                                            }); // for auto-incrementing ids
//                     console.log("Created counter for auto-incrementing group ids...");
//                     //------
...
*/
async function createGroupIndex(userCollection) {
    await userCollection.createIndexes( { "_id": 1 }, { unique: true });
}
...
async function initializeDB() {
    ...
    try {
        ...
        // add group record - this is for testing purposes and to refer to the JSON format
        const familyGroup = {
            // id: 1,
            name: 'Family',
            progressBar: true,
        ...
        // add user record - this is for testing purposes and to refer to the JSON format
        const userMax = {
            emailId: 'max123@gmail.com',
            // TODO figure out how to add group _id and not id field
            groupIds: [],
